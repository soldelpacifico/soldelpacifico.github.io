...
ALLOWED_HOSTS = [
    'soldelpacifico.cl', '138.0.120.16', 'localhost', 'soldelpacifico.pythonanywhere.com'
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [PROJECT_PATH + 'sol/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATIC_ROOT=os.path.join(PROJECT_PATH, 'sol/static/')
